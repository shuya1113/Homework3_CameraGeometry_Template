...
\includegraphics[width = 0.25\linewidth]{epipolar-a.PNG}
\item converge to a point outside of the image plane, and

\includegraphics[width = 0.25\linewidth]{epipolar-b.PNG}
\end{enumerate}
...
\begin{enumerate}[(c)]
\item What might you need to change about your calculations if you obtained the following epipolar lines? (Hint: check slides from the lecture on stereo geometry.)

\includegraphics[width = 0.25\linewidth]{epipolar-c.PNG}
\end{enumerate}
