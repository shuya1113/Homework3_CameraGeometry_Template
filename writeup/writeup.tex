...
\begin{itemize}
  ...
  \item List any extra credit attempted at the beginning.
  \item Feel free to include code snippets, images, and equations.
  \item Use as many pages as you need, but err on the short side. If you feel you only need to write a short amount to meet the brief, then that is fine.
  \item \textbf{Please make this document anonymous.}
\end{itemize}

\section{Extra credit attempted}
\begin{itemize}
    \item One - for ease of grading, please list here, or leave this section empty if none is attempted. You can provide a fuller description later on in the document.
    \item Two
    \item Three
\end{itemize}
...
\section{Extra Credit Implementation}

Wonders abound! It worked!
