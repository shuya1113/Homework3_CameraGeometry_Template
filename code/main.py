...
def main():
    ...
    #################################################
    # Code workflow most relevant to students
    # 
    # 1) Load in the data
    ...
    # Course solution code generates ~1000 interest points per image.

    # View your corners by uncommenting these next lines.
    # Make sure your interest points aren't rotated with respect to the image!
    ...
    # Course solution code generates ~150 matches.
    ...
    # are not testing on those image pairs, as only those pairs have ground truth
    # available.
    #
